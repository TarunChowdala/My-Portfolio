        ...
        <div id="work" className="w-full px-[12%] py-10 scroll-mt-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 my-10 gap-5 dark:text-black">
                {work.map((workItem, index) => (
                    <div 
                        key={workItem.name} 
                        className="aspect-square bg-no-repeat bg-center rounded-lg relative  group overflow-hidden block" 
                        style={{ backgroundImage: `url(${workItem.icon})` , backgroundSize: 'contain' }}
                    >
